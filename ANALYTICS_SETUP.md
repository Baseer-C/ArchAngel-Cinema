...
2. Paste the Google tag immediately after `<head>` in all four HTML pages.
3. Mark `generate_lead` as a key event in GA4.
4. Verify the site in Search Console and link it to the GA4 property.
5. Create one Microsoft Clarity project and paste its tracking snippet into the same four page heads.
